...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'tamanna1424.be21@chitkara.edu.in',
    pass: 'igeb clcr hfjn etsz',
  },
});
const sendVerificationEmail =(email, verificationToken) => {
  ...
  const mailOptions = {
    from: 'tamanna1424.be21@chitkara.edu.in',
    to: email,
...
const authController = {
 ...
 register : async (req, res) => {
  try {
    ...
    const isAdmin = username.toLowerCase() === 'tamannachugh' && email.toLowerCase() === 'tamanna1424.be21@chitkara.edu.in';
